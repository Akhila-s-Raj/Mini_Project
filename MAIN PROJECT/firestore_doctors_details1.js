...
doctorForm.addEventListener("submit", async function (e) {
    ...
    try {
        ...
        const doctorListData = {
            ...
            department: selectedDepartment,
            photoURL: "", // Placeholder for the photo URL (to be updated after upload)
            appointment: {
                days: appointmentDays,
                startTime: startTime,
                endTime: endTime,
        ...
        // Update the photoURL field in the doctorListData object
        doctorListData.photoURL = photoURL;
